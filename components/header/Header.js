  ...
  "
      >
        <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
          <button
            ...
            id="boton"
            className="navbar-toggler text-gray-500 border-0 hover:shadow-none hover:no-underline py-2 px-2.5 bg-transparent lg:hidden focus:outline-none focus:ring-0 focus:shadow-none focus:no-underline"
            type="button"
          ...
          <div className="collapse navbar-collapse flex-grow items-center hidden lg:block" id="menu">
    ...
    "
        ...
        "
            ...
            <div className="dropdown relative" id="menu">
              <a
