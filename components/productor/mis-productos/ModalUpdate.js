...
export const ModalUpdate = ({ closeModal, id, user }) => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-50 m-auto block h-max w-10/12 rounded-lg border bg-white p-6 shadow-lg sm:w-8/12 md:w-6/12 md:p-8 md:pt-4 lg:w-4/12">
