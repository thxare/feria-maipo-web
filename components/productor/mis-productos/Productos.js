  ...
  return (
    <div className="m-4">
      <div className="flex flex-row justify-end">
        <button className="m-4 mr-1 rounded bg-green py-2 px-4 font-bold text-white hover:bg-darkGreen shadow-lg">
          Modificar Producto
        </button>
        <button className="m-4 ml-2 rounded bg-red py-2 px-4 font-bold text-white hover:bg-bordeaux shadow-lg">
          Eliminar Producto
        </button>
      </div>
